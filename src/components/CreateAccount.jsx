        ...
        <form onSubmit={handleSubmit}>
          <section className='form-elements flex flex-col items-start justify-between'>
            ...
            <section className='field flex flex-col relative pb-4 mx-12'>
              ...
              <input name='lastname' type='password' placeholder='Enter last name' value={password} onChange={(e) => setPassword(e.target.value)} className='rounded border border-gray-300 h-8 px-2w-48  sm:w-72' />
            </section>
